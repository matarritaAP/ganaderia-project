...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 29-10-2024 a las 05:22:08
...
--
-- Estructura de tabla para la tabla `tbbovinocompra`
--

CREATE TABLE `tbbovinocompra` (
  `tbbovinocompraid` int(11) NOT NULL,
  `tbbovinocompranumero` varchar(50) NOT NULL,
  `tbbovinocompranombre` varchar(100) DEFAULT NULL,
  `tbbovinocomprapadreid` int(11) DEFAULT NULL,
  `tbbovinocompramadreid` int(11) DEFAULT NULL,
  `tbbovinocomprafechanacimiento` date DEFAULT NULL,
  `tbbovinocomprafechacompra` date NOT NULL,
  `tbbovinocompraprecio` decimal(10,2) NOT NULL,
  `tbbovinocomprapeso` decimal(10,2) DEFAULT NULL,
  `tbbovinocompravendedor` varchar(100) NOT NULL,
  `tbbovinocompraraza` varchar(100) NOT NULL,
  `tbbovinocompraestado` varchar(100) NOT NULL,
  `tbbovinocompragenero` enum('Vaca','Toro') NOT NULL,
  `tbbovinocomprafincaid` int(11) NOT NULL,
  `tbbovinocompraproductorid` int(11) NOT NULL,
  `tbbovinocompradetalle` text DEFAULT NULL,
  `tbbovinocompraactivo` tinyint(4) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Volcado de datos para la tabla `tbbovinocompra`
--

INSERT INTO `tbbovinocompra` (`tbbovinocompraid`, `tbbovinocompranumero`, `tbbovinocompranombre`, `tbbovinocomprapadreid`, `tbbovinocompramadreid`, `tbbovinocomprafechanacimiento`, `tbbovinocomprafechacompra`, `tbbovinocompraprecio`, `tbbovinocomprapeso`, `tbbovinocompravendedor`, `tbbovinocompraraza`, `tbbovinocompraestado`, `tbbovinocompragenero`, `tbbovinocomprafincaid`, `tbbovinocompraproductorid`, `tbbovinocompradetalle`, `tbbovinocompraactivo`) VALUES
(1, 'BV001', 'Toro Bravo', 5, 2, NULL, '2023-02-10', 3500.00, 950.25, 'Carlos Ramírez', 'Angus', 'Novillo', 'Toro', 5, 4, 'Compra de toro fuerte para mejorar la producción.', 1),
(2, 'BV002', 'Vaca Mansa', 1, 2, NULL, '2023-04-12', 2400.00, 690.80, 'Lucía González', 'Guernsey', 'Vaca Lechera', 'Vaca', 16, 4, 'Adquisición de vaca mansa para aumentar la producción de leche.', 1),
(3, 'BV003', 'Toro Fuerte', 5, 4, '2022-07-20', '2023-06-15', 3800.00, 890.45, 'José Fernández', 'Ayrshire', 'Novillo', 'Toro', 17, 4, 'Toro joven con buena genética para cruces futuros.', 1),
(4, 'BV004', 'Vaca Bella', 0, 0, '2022-11-03', '2023-10-10', 2700.00, 730.30, 'Pedro Jiménez', 'Brown Swiss', 'Vaca Lechera', 'Vaca', 18, 4, 'Compra de vaca bella para producción lechera.', 1),
(5, 'BV005', 'Toro Negro', 0, 0, '2021-07-11', '2023-08-11', 3500.00, 960.70, 'Marta Sánchez', 'Bue Lapon', 'Toro', 'Toro', 0, 4, 'Adquisición de toro robusto para cruce.', 1),
(6, 'BV006', 'Vaca Suave', 0, 0, NULL, '2022-05-15', 2200.00, 720.55, 'Carlos Ramírez', 'Brahman', 'Cría Destetada', 'Vaca', 16, 4, 'Vaca joven para producción futura.', 1),
(7, 'BV007', 'Toro Bravo Jr.', NULL, NULL, '2021-12-01', '2023-12-15', 3800.00, 940.80, 'José Fernández', 'Brahman', 'Toro', 'Toro', 17, 4, 'Compra de toro joven para mejorar el hato.', 1),
(8, 'BV008', 'Vaca Dulce', NULL, NULL, '2021-11-05', '2023-09-10', 2500.00, 680.90, 'Lucía González', 'Brown Swiss', 'Vaca Lechera', 'Vaca', 18, 4, 'Adquisición de vaca lechera para aumentar producción.', 1),
(9, 'BV009', 'Toro Salvaje', NULL, NULL, '2022-02-20', '2023-11-30', 3700.00, 920.40, 'Pedro Jiménez', 'Angus', 'Novillo', 'Toro', 5, 4, 'Toro salvaje adquirido para cruces fuertes.', 1),
(10, 'BV010', 'Vaca Serena', NULL, NULL, '2020-06-15', '2023-04-20', 2600.00, 690.75, 'Marta Sánchez', 'Guernsey', 'Cría Destetada', 'Vaca', 16, 4, 'Compra de vaca serena para producción de leche.', 1),
(11, 'BV011', 'Vaca Brava', 9, 2, '2022-12-08', '2024-10-18', 2700.00, 740.60, 'Carlos Ramírez', 'Brown Swiss', 'Vaca Lechera', 'Toro', 16, 4, 'Vaca de temperamento fuerte para aumentar la manada.', 1),
(12, 'BV012', 'Vaca Brava', 3, 4, '2023-02-10', '2024-10-09', 2900.00, 900.25, 'Jose Fernandez', 'Brahman', 'Novillo', 'Vaca', 18, 4, NULL, 1),
(13, 'BVN090', 'Prueba', 0, 0, '2024-10-21', '2024-10-21', 870000.00, 850.45, 'Carlos Ramírez', 'Guernsey', 'Toro', 'Vaca', 17, 4, NULL, 1);

-- --------------------------------------------------------


--
-- Estructura de tabla para la tabla `tbbovinoevento`
--

CREATE TABLE `tbbovinoevento` (
  `tbbovinoeventoid` int(255) NOT NULL,
  `tbbovinoid` int(255) NOT NULL,
  `tbbovinoeventotipo` varchar(10) NOT NULL,
  `tbbovinoeventofecha` date NOT NULL,
  `tbbovinoeventodescripcion` text DEFAULT NULL,
  `tbbovinoeventoproductorid` int(11) NOT NULL,
  `tbbovinoeventoactivo` tinyint(1) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Volcado de datos para la tabla `tbbovinoevento`
--

INSERT INTO `tbbovinoevento` (`tbbovinoeventoid`, `tbbovinoid`, `tbbovinoeventotipo`, `tbbovinoeventofecha`, `tbbovinoeventodescripcion`, `tbbovinoeventoproductorid`, `tbbovinoeventoactivo`) VALUES
(1, 3, 'Venta', '2024-10-01', 'Venta de toro fuerte', 4, 1),
(2, 13, 'Robo', '2024-10-26', 'Esto es una prueba', 4, 1),
(3, 5, 'Muerte', '2024-10-17', 'Muerte de toro negro', 4, 1);
-- --------------------------------------------------------
--
-- Estructura de tabla para la tabla `tbbovinoparto`
--

CREATE TABLE `tbbovinoparto` (
  `tbbovinopartoid` int(11) NOT NULL,
  `tbbovinopartonumero` varchar(50) NOT NULL,
  `tbbovinopartonombre` varchar(100) DEFAULT NULL,
  `tbbovinopartopadreid` int(11) DEFAULT NULL,
  `tbbovinopartomadreid` int(11) DEFAULT NULL,
  `tbbovinopartofechanacimiento` date NOT NULL,
  `tbbovinopartopeso` decimal(10,2) DEFAULT NULL,
  `tbbovinopartoraza` varchar(100) NOT NULL,
  `tbbovinopartoestado` varchar(100) NOT NULL,
  `tbbovinopartogenero` enum('Vaca','Toro') NOT NULL,
  `tbbovinopartofincaid` int(11) NOT NULL,
  `tbbovinopartoproductorid` int(11) NOT NULL,
  `tbbovinopartodetalle` text DEFAULT NULL,
  `tbbovinopartoactivo` tinyint(4) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Volcado de datos para la tabla `tbbovinoparto`
--

INSERT INTO `tbbovinoparto` (`tbbovinopartoid`, `tbbovinopartonumero`, `tbbovinopartonombre`, `tbbovinopartopadreid`, `tbbovinopartomadreid`, `tbbovinopartofechanacimiento`, `tbbovinopartopeso`, `tbbovinopartoraza`, `tbbovinopartoestado`, `tbbovinopartogenero`, `tbbovinopartofincaid`, `tbbovinopartoproductorid`, `tbbovinopartodetalle`, `tbbovinopartoactivo`) VALUES
(1, 'BVN001', 'Cría Toro 1', 1, 2, '2024-10-18', 400.00, 'Angus', 'Cría al Nacer', 'Toro', 18, 4, NULL, 1);
...
CREATE TABLE `tbcvo` (
  ...
  `tbcvoproductorid` int(11) NOT NULL,
...
INSERT INTO `tbcvo` (`tbcvoid`, `tbcvonumero`, `tbcvofechaEmision`, `tbcvofechaVencimiento`, `tbcvoimagen`, `tbcvoproductorid`, `tbcvoestado`) VALUES
(1, '123', '2024-08-26', '2026-08-25', '../docs/imagenCVO/123.jpg', 4, 1),
(2, '123', '2024-08-26', '2026-08-25', '../docs/imagenCVO/123.jpg', 4, 1);
...
CREATE TABLE `tbenfermedad` (
  `tbenfermedadid` int(11) NOT NULL,
  `tbenfermedadidproductor` int(11) NOT NULL,
  `tbenfermedadnombre` varchar(300) NOT NULL,
  `tbenfermedaddescripcion` varchar(300) NOT NULL,
  `tbenfermedadsintomas` varchar(300) NOT NULL,
  `tbenfermedadestado` tinyint(2) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `tbenfermedad` (`tbenfermedadid`, `tbenfermedadidproductor`, `tbenfermedadnombre`, `tbenfermedaddescripcion`, `tbenfermedadsintomas`, `tbenfermedadestado`) VALUES
(1, 4, 'Enfermedad', 'Enfermedad', 'Enfermedad Sin', 0);
...
(1, 'ADM-NBL', 'Novillo', 'Estado de novillo, ganado joven', 1),
(2, 'ADM-TRN', 'Ternero', 'Estado de ternero, ganado joven', 1),
(3, 'ADM-VCL', 'Vaca Lechera', 'Estado de vaca dedicada a la producción de leche', 1),
(4, 'ADM-TRO', 'Toro', 'Estado de toro, macho adulto', 1),
(5, 'ADM-RPL', 'Reproductor', 'Estado de ganado utilizado para reproducción', 1),
(6, 'ADM-VCR', 'Vaca en Receso', 'Estado de vaca que no está en producción de leche actualmente', 1),
(7, 'ADM-CRD', 'Cría Destetada', 'Estado de cría que ha sido separada de su madre', 1),
(8, 'ADM-VCE', 'Vaca Embarazada', 'Estado de vaca que está gestando', 1),
(9, 'ADM-BEC', 'Becerro', 'Estado de becerro, cría joven', 1),
(10, 'ADM-VTJ', 'Vaca de Trabajo', 'Estado de vaca utilizada para trabajos de campo', 1),
(11, 'ADM-NES', 'Nobillo Mod', 'Estado de novillo, ganado joven', 0),
(12, 'ADM-NAC', 'Cría al Nacer', 'Estado de cría que ha nacido recientemente', 1);
...
(1, '123', '2024-08-01', '2024-08-22', '../docs/imagenFierro/4123.jpg', 0),
...
(5, '123', '2024-08-01', '2024-08-22', '../docs/imagenFierro/4123.jpg', 0),
(6, '123', '0000-00-00', '0000-00-00', '../docs/imagenFierro/4123.jpg', 0),
(7, '456', '2024-10-03', '2030-10-03', '../docs/imagenFierro/4456.jpg', 1);
...
CREATE TABLE `tbfinca` (
  ...
  `tbfincalatitud` decimal(18,15) DEFAULT NULL,
  `tbfincalongitud` decimal(18,15) DEFAULT NULL,
  `tbfincaareatotal` float DEFAULT NULL,
  ...
  `tbfincaareaotracriterio` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL CHECK (json_valid(`tbfincaareaotracriterio`)),
...
INSERT INTO `tbfinca` (`tbfincaid`, `tbfincanumplano`, `tbfincacoordenada`, `tbfincalatitud`, `tbfincalongitud`, `tbfincaareatotal`, `tbfincaareapastoreo`, `tbfincaareaconstruccion`, `tbfincaareaforestal`, `tbfincaareacamino`, `tbfincaareaotracriterio`, `tbfincaestado`) VALUES
(1, 'PLAN001', '12345', NULL, NULL, NULL, 34, 20, 20, 12, NULL, 0),
(2, 'PLAN002', '79-12', NULL, NULL, NULL, 10, 15, 20, 5, NULL, 1),
(3, 'PLAN003', '12-76', NULL, NULL, NULL, 20, 30, 40, 10, NULL, 1),
(4, 'PLAN004', '86-90', NULL, NULL, NULL, 40, 30, 20, 10, NULL, 1),
(5, 'PLAN0012', NULL, 10.319507900656935, -83.922500610351580, 3, NULL, 1, 1, 1, 'null', 1),
(6, 'h-001283', '23424', NULL, NULL, NULL, 2342430, 234242, 2342, 243, NULL, 1),
(7, 'H-12324', '1', NULL, NULL, NULL, NULL, 12345, NULL, 1, NULL, 0),
(8, 'Prueba', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0),
(9, 'PPPP', '12345', NULL, NULL, NULL, 122, 2222, 5555, 12, NULL, 0),
(10, 'P-001', '12-124', NULL, NULL, NULL, NULL, 12, NULL, NULL, NULL, 1),
(11, 'P-00112', '76-88', NULL, NULL, NULL, NULL, NULL, 12, NULL, NULL, 1),
(13, 'PLAN077', NULL, 10.362879552284710, -84.457397460937510, 6300, 1000, 1200, 3100, 1000, 'null', 0),
(14, 'PLAN102', NULL, 10.292625404794213, -84.122314453125010, 6, 3, 2, 1, NULL, '{\"Criterio Prueba\":\"12000\"}', 0),
(15, 'PLAN103', NULL, NULL, NULL, 12, 3, 4, 5, NULL, '{\"Criterio Prueba\":\"12000\"}', 0),
(16, 'ABC-102', NULL, 10.451157779086762, -84.014704227447520, 155000, 150000, 2000, 3000, NULL, '{\"Criterio 1\":\"12000\"}', 1),
(17, 'PLAN0122', NULL, 10.332103075152196, -84.426498413085950, NULL, NULL, NULL, NULL, NULL, '{\"Criterio 1\":\"62345\"}', 1),
(18, 'ABC-777', NULL, 10.218404055513530, -83.776695728302020, 18000, 10000, 2000, 5000, 1000, '{\"\\u00c1rea de R\\u00edo\":\"3000\"}', 1);
...
--
-- Estructura de tabla para la tabla `tbhistoricofierro`
--

CREATE TABLE `tbhistoricofierro` (
  `tbhistoricoid` tinyint(4) NOT NULL,
  `tbhistoriconumero` varchar(255) NOT NULL,
  `tbhistoricofechaemision` date NOT NULL,
  `tbhistoricofechavencimiento` date NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(1, 'ADM-BOV01', 'Ganado Lechero', 'Finca dedicada a la producción de leche bovina', 1),
(2, 'ADM-BOV02', 'Ganado Cárnico', 'Finca enfocada en la cría de ganado para producción de carne.', 1),
(3, 'ADM-AV01', 'Aves de Corral', 'Finca destinada a la cría de aves para producción de carne y huevos.', 0),
(4, 'ADM-POR01', 'Cerdos', 'Finca especializada en la cría de cerdos para producción de carne.', 1),
(5, 'ADM-OV01', 'Ovejas', 'Finca dedicada a la cría de ovejas para lana y carne.', 1),
(6, 'ADM-CAP01', 'Cabras', 'Finca enfocada en la cría de cabras para leche y carne.', 1),
(7, 'ADM-MIS01', 'Mixto', 'Finca con una combinación de diferentes tipos de ganado y cultivos.', 1),
(8, 'ADM-AG01', 'Cultivos de Granos', 'Finca dedicada a la producción de granos como maíz, trigo y soja.', 1),
(9, 'ADM-FR01', 'Frutales', 'Finca especializada en el cultivo de frutas como manzanas, naranjas y uvas.', 1),
(10, 'ADM-VEG01', 'Hortalizas', 'Finca enfocada en la producción de hortalizas y vegetales.', 1),
(11, 'PRD-4-NATNAT00', 'Naturaleza Propia', 'Naturaleza Propia Descripción', 1);
...
CREATE TABLE `tbproductor` (
  ...
  `tbproductornombreganaderia` varchar(100) DEFAULT NULL,
...
INSERT INTO `tbproductor` (`tbproductorid`, `tbproductordocidentidad`, `tbproductornombreganaderia`, `tbproductornombre`, `tbproductorprimerapellido`, `tbproductorsegundoapellido`, `tbproductorfechanac`, `tbproductoremail`, `tbproductorcelular`, `tbproductordireccion`, `tbproductorcontrasenia`, `tbproductorestado`) VALUES
(1, '702160258', NULL, 'Michael', 'Umaña', 'Rojas', '1992-10-05', 'maikolur@gmail.com', '84944221', 'Guacimo-LImon', '$2y$10$BpcEIS3DU/hzuFzlEpxeReF2jVciEEWW81ttJYPVjA3Af9HAzIWrG', 1),
(2, '702580654', NULL, 'Juan', 'Mendez', 'Sequeira', '2024-08-01', 'juan@gmail.com', '84256447', 'San Jose', '$2y$10$I1Vs3gYfln9XP0JDtaMZB.OV5qU1FX9Cx/T4Syw2LsJuOBeQB42/2', 1),
(3, '119160537', NULL, 'Aaron', 'Matarrita', 'Portuguez', '2004-09-10', 'aaronmatarritaportuguez@gmail.com', '60900809', 'Heredia, Sarapiquí', '$2y$10$I1Vs3gYfln9XP0JDtaMZB.OV5qU1FX9Cx/T4Syw2LsJuOBeQB42/2', 1),
(4, '888888', '', 'Prueba', 'Prueba', 'Prueba', '2024-08-22', 'Prueba@gmail.com', '12345678', 'Heredia Barva', '$2y$10$I1Vs3gYfln9XP0JDtaMZB.OV5qU1FX9Cx/T4Syw2LsJuOBeQB42/2', 1),
(5, '000000', NULL, 'Test', 'Apellido Test', 'Apellido Segundo Test', '2024-09-08', 'test@gmail.com', '12345677', 'San José, Costa Rica', '$2y$10$jYsFEM2kqYIQcuFe7t446ufpPe7Hy.kk4VMYxKW.pW.TSNHjAcyei', 1),
(6, '11223344556', 'xxx', 'Yeiler', 'Montes', 'Rojas', '1997-12-17', 'yeiler@gmail.com', '63454110', 'Horquetas', '$2y$10$aBrwsIy4.KMxwFlC9kQCtunxwX3d6PD1XdfJOcXtWBoHCYgu1T7oO', 1);
...
(30, 'ADM-SAN', 'Santa Gertrudis', 'Raza de carne conocida por su resistencia y buena adaptabilidad a diferentes climas.', 0),
(31, 'ADM-BLA', 'Bramha', 'AS', 1),
(32, 'ADM-AS', 'Blue Angus', 'as', 0),
(33, 'PRD-3-NUECRU00', 'Nueva raza', 'cruce propio', 1),
(34, 'PRD-4-NUERAZ00', 'Nueva Raza Aaron', 'Raza insertada desde razas propias', 1);
...
(1, 'ADM-S01', 'Agua', 'Servicio de suministro de agua para la finca', 1),
(2, 'ADM-S02', 'Luz', 'Servicio de suministro eléctrico para la finca', 1),
(3, 'ADM-S03', 'Internet', 'Servicio de conexión a Internet en la finca', 1),
(4, 'ADM-S04', 'Recolección de Basura', 'Servicio de recolección y disposición de residuos', 1),
(5, 'ADM-S05', 'Mantenimiento de Equipos', 'Servicio de mantenimiento de equipos y maquinaria', 1),
(6, 'ADM-S06', 'Control de Plagas', 'Servicio para el control y prevención de plagas', 1),
(7, 'ADM-SO7', 'Atención veterinaria para el ganado', 'Servicios de salud y cuidado animal', 1),
(8, 'ADM-SO8', 'Suministro de alimentos para el ganado', 'Servicios de alimentación para animales', 1),
(9, 'ADM-SO9', 'Servicio de transporte para la finca', 'Transporte de productos y materiales', 1),
(10, 'ADM-SO10', 'Servicio de seguridad en la finca', 'Servicios de vigilancia y seguridad', 1),
(11, 'PRD-4-PRUSER00', 'PruebaPropio', 'Servicio Propio MOD', 1),
(12, 'ADM-S011', 'Mantenimiento de cercas', 'Servicio de mantenimiento de cercas', 1);
...
(4, 'PRODUCTOR', 3, NULL, 'aaron@gmail.com', '$2y$10$I1Vs3gYfln9XP0JDtaMZB.OV5qU1FX9Cx/T4Syw2LsJuOBeQB42/2', 1),
...
(7, 'PRODUCTOR', 6, NULL, 'yeiler@gmail.com', '$2y$10$aBrwsIy4.KMxwFlC9kQCtunxwX3d6PD1XdfJOcXtWBoHCYgu1T7oO', 1);
...
CREATE TABLE `tbtipomedicamento` (
  ...
  `tbtipoMedicamentoNombre` varchar(300) NOT NULL,
...
INSERT INTO `tbtipomedicamento` (`tbtipoMedicamentoid`, `tbtipoMedicamentoNombre`, `tbtipoMedicamentoEstado`) VALUES
(1, 'Antibióticos', 1),
...
--
-- Estructura de tabla para la tabla `tbtratamientobovino`
--

CREATE TABLE `tbtratamientobovino` (
  `tbtratamientobovinoid` int(11) NOT NULL,
  `tbbovinoid` varchar(300) NOT NULL,
  `tbtratamientobovinofecha` date NOT NULL,
  `tbtratamientobovinoenfermedadid` int(11) NOT NULL,
  `tbtratamientobovinotipomedicamentoid` varchar(300) NOT NULL,
  `tbtratamientobovinodosis` varchar(5000) NOT NULL,
  `tbtratamientobovinoestado` tinyint(10) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Volcado de datos para la tabla `tbtratamientobovino`
--

INSERT INTO `tbtratamientobovino` (`tbtratamientobovinoid`, `tbbovinoid`, `tbtratamientobovinofecha`, `tbtratamientobovinoenfermedadid`, `tbtratamientobovinotipomedicamentoid`, `tbtratamientobovinodosis`, `tbtratamientobovinoestado`) VALUES
(1, 'Vaca Mansa', '2024-10-10', 80, 'Vitaminas', '100 ml, dos veces al día', 1),
(2, 'Toro Salvaje', '2024-10-23', 75, 'Analgesicos', '7,5 mg', 1),
(3, 'Vaca Mansa', '2024-10-23', 99, 'Vacunas', 'Una dosis al dia', 1),
(4, 'Toro Fuerte', '2024-10-31', 75, 'Vitaminas', 'Dos veces al dia', 1),
(5, 'Vaca Brava', '2024-10-31', 97, 'Antifúngicos', '150 mg al dia', 0),
(6, 'Toro Negro', '2024-10-03', 35, 'Sedantes', '0.25-0.5 mg', 1),
(7, 'Toro Bravo', '2024-10-02', 85, 'Suplementos Minerales', '50 mg', 1),
(8, 'Vaca Bella', '2024-10-03', 22, 'Antibióticos', '40 mg', 1);
